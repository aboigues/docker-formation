# TP8 — Sécuriser ses images : scanner, durcir, transférer hors-ligne

> Durée estimée : 1 h · Ports utilisés : `8087`
> Prérequis : TP3 (Dockerfile). Outil requis : **Trivy** (installation ci-dessous).
...
5. **Healthcheck distroless.** L'image n'a pas de shell : comment ajouter un `HEALTHCHECK` ? (Piste : un mini binaire de health, ou déléguer la sonde à l'orchestrateur — cf. TP10.)
